export default {
    "en": {
        ...
        "tnorthern": "northern",
        "tsouthern": "southern",
        "tSpecialDay": "\u26a0\ufe0f Careful: In the %h hemisphere, this day is <b>%s</b>!%w",
        ...
        "tInfoRunningC": "Searching, hold on... Found %d possible {seed|seeds} so far:",
        ...
        "tInfoMultiSeed": "It looks like there are %d seeds that fit the information you've given: %s. You can look at these by putting them into Step 3 below to see how they compare to your island, or you can add more data above and try searching again.",
        "tInfoSeed": "Your island's weather seed is <b>%d</b>. Write it down somewhere for safekeeping, and move onto Step 3!",
        "tStarConflict": "You have a gap saying that at %t on %d, there both is and isn't a star. Please fix it!",
        "tBadRainbowN": "You said %s has a rainbow, but that can't happen in the northern hemisphere - they begin on the 25th February and end on the 25th November.",
        "tBadRainbowS": "You said %s has a rainbow, but that can't happen in the southern hemisphere - they begin on the 25th August and end on the 25th May.",
        "tBadAuroraN": "You said %s has the aurora borealis, but that can't happen in the northern hemisphere - it begins on the 11th December and ends on the 24th February.",
        "tBadAuroraS": "You said %s has the aurora australis, but that can't happen in the southern hemisphere - it begins on the 11th June and ends on the 24th August.",
        ...
        "tsCancel": "Cancel",
        "tsSave": "Save",
        "yLight": "\u2728 %d light {shower|showers}",
        "yHeavy": "\ud83c\udf20 %d heavy {shower|showers}",
        "yRainbow": "\ud83c\udf08 %d {rainbow|rainbows}",
        "yRainbowDouble": "\ud83c\udf08 %d {rainbow|rainbows} (%z double)",
        "yAurora": "\ud83c\udf0c %d aurora borealis {day|days}",
        "dTitlePreview": "Preview of pattern %s",
        "dTitleDay": "Weather for %d (%s)",
        "dSpDay": "\ud83c\udf89 This day has special weather because of %s",
    ...
    "es": {
        ...
        "tnorthern": "norte",
        "tsouthern": "sur",
        "tSpecialDay": "\u26a0\ufe0f Aviso: En el hemisferio %h, este d\u00eda es <b>%s</b>!%w",
        ...
        "tInfoRunningC": "Buscando, espera... %d {semilla posible|semillas posibles} encontrada:",
        ...
        "tInfoMultiSeed": "Parece que hay %d semillas que encajan con la informaci\u00f3n que has puesto: %s. Si quieres comprobarlas, puedes introducir cada una en el paso 3 para ver c\u00f3mo se comparan con el tiempo en tu isla. Si no, a\u00f1ade m\u00e1s datos en este paso e intenta buscar otra vez.",
        "tInfoSeed": "La semilla ambiental en tu isla es <b>%d</b>. Ap\u00fantala en alg\u00fan lado para no perderla, \u00a1y sigue al 3\u00ba paso!",
        "tStarConflict": "Tienes un hueco diciendo que a las %t del %d hubo y no hubo un meteorito. \u00a1Arregla eso!",
        "tBadRainbowN": "Dijiste que el %d hubo un arco\u00edris, pero esto no puede pasar en el hemisferio norte - aparecen desde el 25 de febrero hasta el 25 de noviembre.",
        "tBadRainbowS": "Dijiste que el %d hubo un arco\u00edris, pero esto no puede pasar en el hemisferio sur - aparecen desde el 25 de agosto hasta el 25 de mayo.",
        "tBadAuroraN": "Dijiste que el %d hubo una aurora, pero esto no puede pasar en el hemisferio norte - aparecen desde el 11 de diciembre hasta el 24 de febrero.",
        "tBadAuroraS": "Dijiste que el %d hubo una aurora, pero esto no puede pasar en el hemisferio sur - aparecen desde el 11 de junio hasta el 24 de agosto.",
        ...
        "tsCancel": "Cancelar",
        "tsSave": "Guardar",
        "yLight": "\u2728 %d {lluvia leve de meteoritos|lluvias leves de meteoritos}",
        "yHeavy": "\ud83c\udf20 %d {lluvia fuerte de meteoritos|lluvias fuertes de meteoritos}",
        "yRainbow": "\ud83c\udf08 %d arco\u00edris",
        "yRainbowDouble": "\ud83c\udf08 %d arco\u00edris (%z doble)",
        "yAurora": "\ud83c\udf0c %d {d\u00eda|d\u00edas} con aurora",
        "dTitlePreview": "Ejemplo del patr\u00f3n %s",
        "dTitleDay": "El tiempo para %d (%s)",
        "dSpDay": "\ud83c\udf89 Este d\u00eda hace un tiempo especial porque se celebra %s",
